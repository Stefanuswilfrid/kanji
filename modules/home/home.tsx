        ...
        <HyperLinkButton
          ...
          icon={
            <GraduationCapIcon
              size={48}
              strokeWidth={1.5}
              className="duration-[200ms] group-hover:text-yellow-500"
            />
          }
          href="//"
        ...
        <Button
          ...
          icon={
            <TargetIcon
              size={48}
              strokeWidth={1.5}
              className="duration-[200ms] group-hover:text-indigo-500"
            />
          }
        ...
        <LinkButton
          ...
          icon={
            <BookmarkIcon
              size={48}
              strokeWidth={1.5}
              className="duration-[200ms] group-hover:text-emerald-500"
            />
          }
          title="Bookmarks"
