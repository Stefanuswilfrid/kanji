    ...
    <button onClick={() => onPlaylistClicked(playlist.diocoPlaylistId)} className="active:opacity-80 transition w-full">
      <div className="overflow-hidden">
        ...
        <div className="mt-4 space-y-1 px-1">
          ...
          <p className="text-sm text-secondary">{playlist.satisfiesFiltersCount} {videosCountLabel}</p>
        </div>
      </div>
    </button>
  );
        ...
        <div className="relative overflow-y-auto scrollbar h-[calc(100vh-108px-33px)]">
          <div className="sticky top-0 z-50 bg-black">
            ...
            >
              ...
              <p className="font-medium text-smokewhite group-active:opacity-80">{t.youtube?.backToChannelList ?? "Back to Channel List"}</p>
            </button>
          </div>
