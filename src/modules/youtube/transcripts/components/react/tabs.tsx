...
import { formatTime } from "@/modules/youtube/utils/media";
import { getColorClass, getFreqRangeLabel, getTransliteration } from "../utils";
import { freqColorMap, posColorMap } from "../constants";
